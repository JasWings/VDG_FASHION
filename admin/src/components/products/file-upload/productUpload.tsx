...
export default function ProductUpload(props: { used?: number; total?: number; [x: string]: any,productDetails:any,setProductDetails:any}) {
  ...
  return (
	...
	<Flex>
	  <ProductUploadedImages images={selectedFiles} selectedImages={uploadedImages} onSelectImage={(image) => {}} onDelete={handleDelete} />
	</Flex>
  </Flex>
  </FormControl>
	</>
