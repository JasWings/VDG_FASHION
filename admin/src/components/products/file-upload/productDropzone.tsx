...
function ProductDropzone(props: { content: JSX.Element | string; onFilesSelected: (files: File[]) => void; [x: string]: any}) {
  ...
  return (
    <Flex
      ...
      >
      <input 
      {...getInputProps({name:"productImage"})}   
      id='productdropzoneid231' 
      name='productdropzoneid231'  
      style={{
        display: 'initial',
        opacity: '0',
        position: 'absolute',
