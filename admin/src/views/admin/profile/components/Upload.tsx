...
import UploadedImages from './uploadImage';
...
export default function Upload(props: { used?: number; total?: number; [x: string]: any,productDetails:any,setProductDetails:any}) {
  ...
  return (
	...
	<Flex>
	  <UploadedImages images={selectedFiles} selectedImages={uploadedImages} onSelectImage={(image) => {}} onDelete={handleDelete} />
	</Flex>
  </Flex>
  </FormControl>
	</>
