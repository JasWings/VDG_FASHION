export const API_ENDPOINTS = {
  ...
  UPDATE_PAYMENT_METHOD: "/commerce/cart/update-payment-method",
  ...
  REVOKE_COUPON : '/coupons/revoke-coupon',
  ...
  USERS_VERIFY_FORGOT_PASSWORD_TOKEN: '/auth/verify-forgot-password-otp/',
