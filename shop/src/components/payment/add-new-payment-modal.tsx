...
const AddNewPaymentModal = () => {
  ...
  return (
    <div className="payment-modal flex justify-center relative h-full w-full overflow-hidden rounded-[10px] bg-light md:h-auto md:min-h-0 md:max-w-2xl lg:w-screen lg:max-w-[46rem]">
      <PaymentComponent
