...
function TagInputs({ allTags ,setInputValue,setMatchedTags,selectedTags,setSelectedTags,inputValue,matchedTags,handleUpdateTags,productDetails,setProductDetails}) {
  ...
  const handleTagSelect = (tag) => {
    setSelectedTags([...selectedTags, tag.identity]);
  ...
  const handleAddTagToDatabase = async(newTag) => {
    ...
    const response=await CreateNewTag(CreateTagEndPoint,{identity:newTag,slug:newTag},header)
